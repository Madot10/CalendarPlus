    ...
    if(time || week){
        ...
        .onsuccess = function(event){
            ...
            if(cursor){
                ...
                liElem.innerHTML = `<span class="badge badge-danger badge-pill clicker" onclick="delEvento(${cursor.primaryKey}, this)" touchstart ="delEvento(${cursor.primaryKey}, this)" >&times;</span><b>${cursor.value.titulo} (${getHr(cursor.value.hora)}):</b> <i>${cursor.value.data}</i>`;
